...
def create_cluster_policy(policy_name:str, company_name:str, policy_id:str=None, other_info:dict={}, exception:bool=False):
    """
    ...
    if other_info:
        for key in other_info:
            new_policy['cluster'][key] = other_info[key]
    if policy_id:
