...
config
"""
import anylog_api.anylog_connector
...
def node_policy(conn:anylog_api.anylog_connector.AnyLogConnector, node_type:str, name:str, company:str, policy_id:str=None,
                external_ip:str='!external_ip', local_ip='!ip', rest_ip:str=None, broker_ip:str=None,
                server_port='!anylog_server_port', rest_port='!anylog_rest_port', broker_port=None,
                server_bind:bool=False, cluster_id:str=None, geoloc:str=None, country:str=None, state:str=None,
                city:str=None, scripts:list=[], exeception:bool=False)->str:
    """
    Create cluster policy
    :args:
        name:str - cluster name
