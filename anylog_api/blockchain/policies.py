...
"""
def create_cluster_policy(name:str, owner:str, db_name:str=None, table:str=None, parent:str=None, policy_id:str=None)->dict:
    """
    Declare cluster policy
    :sample-policy:
        {'cluster' : {
            'parent' : 'a17d8e5f176614479d263d9bc0dab125',
            'name' : 'edgex-cluster1',
            ...
            'id' : '3bc97624617d962c4c8b1b5f59d59089'
        }}
    :args:
    ...
    :params:
        cluster_policy:dict - Generated cluster policy
    :return:
        cluster_policy
    """
    cluster_policy = {
    ...
    if policy_id:
        cluster_policy['cluster']['id'] = policy_id
...
def create_node_policy(node_type:str, node_name:str, owner:str, ip:str, anylog_server_port:int, anylog_rest_port:str,
                       local_ip:str=None, anylog_broker_port:int=None, cluster_id:str=None, policy_id:str=None, is_main:bool=False,
                       location:dict=None, other_params:dict=None, scripts:list=None)->dict:
    """
    ...
    if policy_id:
        node_policy[node_type]['id'] = policy_id
...
def generic_policy(policy_type:str, policy_name:str, owner:str, scripts:list=[], policy_id:str=None, **kwargs)->dict:
    """
    ...
    if scripts:
        new_policy[policy_type]['script'] = scripts
    if policy_id:
        new_policy[policy_type]['id'] = policy_id
