...
class DeployDocker:
    ...
    def deploy_postgres_container(self, username:str, password:str)->bool:
        """
        Deploy Postgres - if a new PSQL container is deployed the code waits 15 seconds before continuing
        :args:
