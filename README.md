...
* **debian-feb8c** - Stable build using Ubuntu 18.04 operating system for amd64 and arm v7 architecture type
* **debian-arm64-feb8c** - Stable build using Ubuntu 18.04 operating system for arm64 architecture type
* **alpine-feb8c** - Stable build using Alpine 3.7 operating system for amd64 and arm v7 architecture type
* **alpine-arm64-feb8c** - Stable  build using Alpine 3.7 operating system for arm64 architecture type
