...
def create_member_policy(member_type:str, name:str, company:str=None, policy_id:str=None)->dict:
    """
    Create a member policy for authentication
    :args:
        member_type:str - member type (root, user, node)
        name:str - policy name
        company:str - company member is associated with
        policy_id:str - overwrite the autogenerated ID
    :params:
