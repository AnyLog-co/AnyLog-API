...
print(anylog_conn.anylog_conn.get(headers={"command": "get status", "User-Agent": "AnyLog/1.23"}))

# print(anylog_conn.node_status.test_node())
# print(anylog_conn.node_status.test_network())
# print(anylog_conn.logging.get_event_log())
# print(anylog_conn.logging.get_error_log())
# anylog_conn.logging.reset_event_log()